...
console.log('ChatMessageList.razor.js UPDATED VERSION loaded!');
...
window.customElements.define('chat-messages', class ChatMessages extends HTMLElement {
    ...
    _scheduleAutoScroll(mutations) {
        ...
        this._nextAutoScroll = requestAnimationFrame(() => {
            // Check for any new message-related content being added
            const hasNewContent = mutations.some(m => 
                Array.from(m.addedNodes).some(n => {
                    if (n.nodeType !== Node.ELEMENT_NODE || n.parentElement !== this) return false;
                    
                    // Check for direct message classes
                    if (n.classList?.contains('user-message') || 
                        n.classList?.contains('assistant-message') ||
                        n.classList?.contains('waiting-message') ||
                        n.classList?.contains('adaptive-card-container')) {
                        console.log('Direct message detected:', n.className);
                        return true;
                    }
                    
                    // Check for nested message classes (ChatMessageItem wrapper)
                    if (n.querySelector && (
                        n.querySelector('.user-message') || 
                        n.querySelector('.assistant-message') ||
                        n.querySelector('.assistant-search') ||
                        n.querySelector('.adaptive-card-container') ||
                        n.querySelector('iframe[src="/sudoku.html"]') ||
                        n.querySelector('iframe[src="/doom-crt.html"]') ||
                        n.querySelector('.connection-card'))) {
                        console.log('Nested message detected in:', n.tagName);
                        return true;
                    }
            ...
            if (ChatMessages._isFirstAutoScroll || hasNewContent || this._elemIsNearScrollBoundary(elem, 300)) {
                // Find the scrollable container and scroll to bottom
                const scrollContainer = this.closest('.message-list-container');
                if (scrollContainer) {
                    console.log('Scrolling to bottom, scrollHeight:', scrollContainer.scrollHeight);
                    scrollContainer.scrollTop = scrollContainer.scrollHeight;
                } else {
                    console.log('Fallback: scrolling element directly');
    ...
    _elemIsNearScrollBoundary(elem, threshold) {
        ...
        if (scrollContainer) {
            ...
            return remainingScrollDistance < (elem?.offsetHeight || 0) + threshold;
        }
    }
});
...
// SIG // qz8Bzk58Jn9lXa2xh+mpPdCe1bChgheUMIIXkAYKKwYB
// SIG // BAGCNwMDATGCF4Awghd8BgkqhkiG9w0BBwKgghdtMIIX
// SIG // aQIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUgYLKoZIhvcN
// SIG // AQkQAQSgggFBBIIBPTCCATkCAQEGCisGAQQBhFkKAwEw
// SIG // MTANBglghkgBZQMEAgEFAAQgcMjyJwmfCxYvzx18ps/j
// SIG // Z2f9R2CNDMFYze6Wq0jexoQCBmhLCGnmxBgTMjAyNTA4
// SIG // MTIxOTAxMDIuMjkxWjAEgAIB9KCB0aSBzjCByzELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // 7QwwIhgPMjAyNTA4MTIxNjQwNDRaGA8yMDI1MDgxMzE2
// SIG // NDA0NFowdDA6BgorBgEEAYRZCgQBMSwwKjAKAgUA7EXt
// SIG // DAIBADAHAgEAAgIjxDAHAgEAAgISfDAKAgUA7Ec+jAIB
// SIG // ADA2BgorBgEEAYRZCgQCMSgwJjAMBgorBgEEAYRZCgMC
// SIG // oAowCAIBAAIDB6EgoQowCAIBAAIDAYagMA0GCSqGSIb